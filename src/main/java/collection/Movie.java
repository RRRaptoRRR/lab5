...
public class Movie implements Comparable<Movie> {
    ...
    public final java.time.LocalDate creationDate;
    ...
    public String toString() {
        return  "Id: " + this.id + "\n" +
                ...
                "Oscar: " + this.oscarsCount + "\n" +
                "Name: "+ this.director.getName() + "\n" +
                "Weight "+ this.director.getWeight() + "\n" +
                "MpaaRating: "+ this.getMpaaRating()+"\n"+
                "Genre: "+ this.getMovieGenre()+"\n";
    }
